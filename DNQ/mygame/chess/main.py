...
observation , reward , done , mod = env.step()
...
mod:0,1代表此步是否有效，2代表棋子位置为空，3代表棋子棋手不匹配
...
class CC():
    ...
    def step(self, action):
        ...
        :return: observation, reward, done, mod
        mod: 0表示将行棋子与将行位置上的棋子的乘积，>0表示两个位置的棋子为同一方
